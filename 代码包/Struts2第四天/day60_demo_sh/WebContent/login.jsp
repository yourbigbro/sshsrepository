...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<BODY>
		<FORM id=form1 name=form1 onsubmit="javascript:return WebForm_OnSubmit();" method="post" action="${pageContext.request.contextPath}/checkUser_User.action">
		<DIV id=UpdatePanel1>
		              								...
		              								<TBODY>
										              	<TR>
										                	...
										                	<TD style="HEIGHT: 28px" width=150>
										                		<INPUT id=txtName style="WIDTH: 130px" name=username></TD>
