		...
		<div class="container">
			<div class="row">
							...
							<c:if test="${not empty cart && not empty cart.cartAll }">
								<c:forEach items="${cart.cartAll }" var="cartItem">
									<tr class="active">
										...
										<td width="15%">
											<span class="subtotal">￥${cartItem.totalPrice }</span><!-- 小计 -->
										</td>
									</tr>
								</c:forEach>
							</c:if>
				...
				<div style="text-align:right;margin-right:120px;">
					商品金额: <strong style="color:#ff6600;">￥${cart.allPrice }元</strong>
				</div>
			...
			<div>
				<hr/>
				<form id="orderForm" class="form-horizontal" style="margin-top:5px;margin-left:150px;" action="${pageContext.request.contextPath}/" method="post">
