...
<SCRIPT language=javascript>
	...
	function changed(lkmId){
		if(confirm("您确定修改联系人吗?")){
			location.href="${pageContext.request.contextPath }/changeLinkMan.action?lkmId="+lkmId;
		}
	}
	
	function deleted(lkmId){
		if(confirm("您确定删除联系人吗?")){
			location.href="${pageContext.request.contextPath }/deleteLinkMan.action?lkmId="+lkmId;
		}
	}
</SCRIPT>
									...
									<TD>
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<c:forEach items="${linkManss }" var="linkman">
												<TR
													...
													<TD>
													<!-- 注意，用方法的话就不能用pageContext.request.contextPath，而应该在方法的定义中写路径 -->
													<!-- 注意EL表达式里面的大小写 -->
													<a href="javascript:changed('${linkman.lkmId}')">修改</a>
													&nbsp;&nbsp;
													<a href="javascript:deleted('${linkman.lkmId}')">删除</a>
													</TD>
												</TR>
												</c:forEach>
											</TBODY>
