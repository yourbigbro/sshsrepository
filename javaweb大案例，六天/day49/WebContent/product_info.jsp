		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/index.jsp">二级分类</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						<div><strong>商品名称：${product.pname }</strong></div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							<div style="margin:5px 0 10px 0;">颜色分类</div>
							<form action="${pageContext.request.contextPath}/UserServlet?type=fillCart" method="post">
								...
								<div style="margin:20px 0 10px 0;;text-align: center;">
									<!-- 表单提交按钮 -->
									<input style="background: url('${pageContext.request.contextPath}/${product.pimage}') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="submit">
									 &nbsp;收藏商品</div>
								</div>
							</form>
					</div>
